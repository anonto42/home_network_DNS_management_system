...
3.  **Verify:** Run `make lint` and `make test` locally to ensure your changes don't break existing functionality or introduce linting errors.
...
- **Verification:** All commits must pass `make lint` and `make test`.
